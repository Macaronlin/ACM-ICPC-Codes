...
int main() {
	...
	rep(n,0,nn) { cout << fac[n] << ' '; } cout << '\n';
	rep(n,0,nn) { cout << fac_inv[n] << ' '; } cout << '\n';
	rep(n,0,nn) { cout << a[n] << ' '; } cout << '\n';
	rep(n,0,nn) { cout << b[n] << ' '; } cout << '\n';
	rep(n,0,nn) { cout << f[n] << ' '; } cout << '\n';
	rep(n,1,nn) {
